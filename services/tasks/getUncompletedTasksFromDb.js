...
const getUncompletedTasksFromDb = async () => {
  ...
  try {
    ...
    const [result] = await pool.execute(
      `SELECT t.TaskTitle, t.TaskDescription, a.Name AS AssigneeName, b.Name AS AssignerName, t.AssignDate, t.DueDate, r.RoleName AS AssigneeRoleName FROM tasks t JOIN staff a ON t.AssigneeID = a.StaffID JOIN staff b ON t.AssignerID = b.StaffID JOIN roles r ON a.RoleID = r.RoleID WHERE t.isCompleted IS NULL OR t.isCompleted != 1;`
    );
...
module.exports = { getUncompletedTasksFromDb };
